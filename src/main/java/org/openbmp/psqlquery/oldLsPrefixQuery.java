...
public class oldLsPrefixQuery extends Query{
	
	public oldLsPrefixQuery(List<Map<String, Object>> rowMap){
    ...
    public String[] genInsertStatement() {
        String [] stmt = { " INSERT IGNORE INTO ls_prefixes " +
								"(hash_id,peer_hash_id, path_attr_hash_id,id,local_node_hash_id," +
